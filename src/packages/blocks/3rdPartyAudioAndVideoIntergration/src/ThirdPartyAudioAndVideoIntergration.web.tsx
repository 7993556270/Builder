...
import ThirdPartyAudioAndVideoIntergrationController, {
  Props,
  configJSON,
} from "./ThirdPartyAudioAndVideoIntergrationController";

export default class ThirdPartyAudioAndVideoIntergration extends ThirdPartyAudioAndVideoIntergrationController {
